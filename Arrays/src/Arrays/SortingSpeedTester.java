...
public class SortingSpeedTester {
	...
	System.out.println("Time at start was " + bubbleStart +  " and time at end was " + bubbleEnd + ".");
	System.out.println("Bubble sort time taken is " + (bubbleEnd-bubbleStart) + " milliseconds.");
	...
	System.out.println("Time at start was " + insertionStart + " and time at end was " + insertionEnd + ".");
	System.out.println("Insertion sort time taken is " + (insertionEnd-insertionStart) + " milliseconds.");
